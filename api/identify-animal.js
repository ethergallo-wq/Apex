...
module.exports = async function identifyAnimal(req, res) {
  ...
  const prompt = [
    ...
    'Se immagine, distanza, sfocatura, occlusione, illuminazione o soggetto non permettono un\'identificazione utile, usa identification_status="unusable", spiega il motivo e lascia alternatives vuoto.',
